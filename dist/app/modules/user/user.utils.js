...
const generateStudentId = (academicSemister) => __awaiter(void 0, void 0, void 0, function* () {
    const currentId = (yield (0, exports.findLastStudentId)()) || (0).toString().padStart(5, '0');
    // increment by 1
    let incrementedId = (parseInt(currentId) + 1).toString().padStart(5, '0');
    incrementedId = `${academicSemister === null || academicSemister === void 0 ? void 0 : academicSemister.year.substring(2)}${academicSemister === null || academicSemister === void 0 ? void 0 : academicSemister.code}${incrementedId}`;
