...
const getAllStudent = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield student_model_1.Student.find(whereCondtions)
        ...
        .skip(skip)
        .limit(limit);
    const total = yield student_model_1.Student.countDocuments(whereCondtions);
    return {
        meta: {
            page,
            limit,
...
const updateStudent = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    */
    ...
    const result = student_model_1.Student.findOneAndUpdate({ id }, updatedStudentData, {
        new: true,
    });
    return result;
});
